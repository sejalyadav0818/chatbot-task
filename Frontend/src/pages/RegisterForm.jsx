...
import VadlidationSchema from "../Validation/VadlidationSchema";
...
const RegisterForm = () => {
  ...
  const handleFormSubmit = async (values, { setSubmitting }) => {
    try {
      // Send a POST request to your backend API endpoint for registration
      ...
      // Handle the response (you might want to check for specific success criteria)
          ...
          {({ handleSubmit, handleChange, values, touched, errors }) => (
            <Form noValidate onSubmit={handleSubmit}>
              <Row>
                ...
                <Col>
                  <Form.Group className="mb-3 mt-10">
                    <Form.Label className="bold-text">FirstName</Form.Label>
                    <Form.Control
                      type="text"
                  ...
                  <Form.Group className="mb-3 mt-10">
                    <Form.Label className="bold-text">LastName</Form.Label>
                    <Form.Control
                      type="text"
